...
?>
<section class="sec nav-page-hero" aria-labelledby="ornek-videos-hero-title">
  <?php include __DIR__ . '/hero-stars.php'; ?>
  <div class="sec-inner sec-inner--nav-hero">
    <p class="nav-page-hero-eyebrow">Örnek videolar</p>
    <h1 id="ornek-videos-hero-title" class="title title--ornek-videos-page">Örnek videolar</h1>
