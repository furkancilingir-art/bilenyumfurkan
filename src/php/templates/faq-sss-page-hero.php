...
?>
<section class="sec nav-page-hero" aria-labelledby="faq-sss-page-hero-title">
  <?php include __DIR__ . '/hero-stars.php'; ?>
  <div class="sec-inner sec-inner--nav-hero">
    <p class="nav-page-hero-eyebrow">SSS</p>
    <h1 id="faq-sss-page-hero-title" class="title title--faq-sss-page">Sıkça Sorulan Sorular</h1>
