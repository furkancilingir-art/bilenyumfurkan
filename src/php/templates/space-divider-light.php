<?php
/**
 * Öğrenci hikayeleri — panel geçişi ile aynı mor/pembe dalga şeridi (landing-reference.css → .space-divider-light).
 */
?>
<div class="space-divider-light" aria-hidden="true">
