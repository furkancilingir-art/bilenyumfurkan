...
<head>
  ...
  <title>Örnek videolar — Bilenyum</title>
  <meta name="description" content="Örnek ders videoları ve Bilenyumlu öğrencilerin hikayeleri." />
...
<body class="page-ornek-videolar">
<div class="site-header"><?php include __DIR__ . '/../php/templates/topbar.php'; ?><?php include __DIR__ . '/../php/templates/header.php'; ?></div>

<?php
$nav_page_intro_title = 'Örnek ders videoları ve öğrenci hikayeleri';
$nav_page_intro_lead = 'Örnek ders kayıtları ve Bilenyumlu öğrencilerin kendi anlatımıyla hikayeleri.';
include __DIR__ . '/../php/templates/ornek-videolar-hero.php';
?>

<?php include __DIR__ . '/../php/templates/space-divider-wave-purple.php'; ?>

<?php include __DIR__ . '/../php/templates/classroom-section.php'; ?>

<?php include __DIR__ . '/../php/templates/student-stories-section.php'; ?>
