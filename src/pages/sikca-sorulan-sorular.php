...
$faq_sss_mode = 'full';
$faq_sss_initial_konu = isset($_GET['konu']) ? preg_replace('/[^a-z0-9_-]/i', '', (string) $_GET['konu']) : '';
?>
<!doctype html>
<html lang="tr">
<head>
  ...
  <title>Sıkça Sorulan Sorular — Bilenyum</title>
  <meta name="description" content="Bilenyum eğitim platformu, paketler, veli ve öğrenci paneli, içerikler ve eğitim setleri hakkında sıkça sorulan sorular ve yanıtlar." />
...
<body class="page-faq-sss">
<div class="site-header"><?php include __DIR__ . '/../php/templates/topbar.php'; ?><?php include __DIR__ . '/../php/templates/header.php'; ?></div>

<?php
$nav_page_intro_title = 'Tüm konular ve yanıtlar';
$nav_page_intro_lead = 'Konuyu soldan seçerek ilgili sorulara ulaşın; her başlığın yanındaki + ile yanıtı açabilirsiniz.';
include __DIR__ . '/../php/templates/faq-sss-page-hero.php';
?>

<?php include __DIR__ . '/../php/templates/space-divider-wave-purple.php'; ?>

<?php
$faq_sss_show_full_intro = false;
include __DIR__ . '/../php/templates/faq-sss-section.php';
?>

<?php include __DIR__ . '/../php/templates/space-divider-light.php'; ?>
