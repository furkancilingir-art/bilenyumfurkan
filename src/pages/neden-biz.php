...
<head>
  ...
  <title>Neden Bilenyum? — Vizyon, misyon ve kurumsal kimlik</title>
  <meta name="description" content="Bilenyum vizyon ve misyonu: yeni nesil eğitim modeli, dijital eğitim evreni, eğitimde fırsat eşitliği, psikolojik rehberlik ve Türkiye Yüzyılı Maarif Modeli ile uyumlu yapay zeka destekli öğrenme manifestosu." />
...
<body class="page-neden-biz">
<div class="site-header"><?php include __DIR__ . '/../php/templates/topbar.php'; ?><?php include __DIR__ . '/../php/templates/header.php'; ?></div>

<?php
$nav_page_intro_title = 'Vizyon ve misyon';
$nav_page_intro_lead = 'Türkiye’nin çocukları için güvenilir, şeffaf ve ölçülebilir bir online eğitim deneyimi sunmak üzere yola çıktık. Vizyonumuz ve misyonumuz, her kararımızın merkezinde öğrenci ve veliyi tutuyor.';
include __DIR__ . '/../php/templates/neden-biz-hero.php';
?>

<?php include __DIR__ . '/../php/templates/space-divider-wave-purple.php'; ?>

<?php include __DIR__ . '/../php/templates/neden-biz-content.php'; ?>
